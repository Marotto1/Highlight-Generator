...
audio = clip.audio
audio.write_audiofile("test_out.wav")


AUDIO_FILE = path.join(path.dirname(path.realpath(__file__)), "test_out.wav")
...
# except sr.RequestError as e:
#     print(
#         "Could not request results from Microsoft Azure Speech service; {0}".format(e)
#     )
...
# HOUNDIFY_CLIENT_ID = (
#     "INSERT HOUNDIFY CLIENT ID HERE"  # Houndify client IDs are Base64-encoded strings
# )
# HOUNDIFY_CLIENT_KEY = (
#     "INSERT HOUNDIFY CLIENT KEY HERE"  # Houndify client keys are Base64-encoded strings
# )
# try:
#     print(
#         "Houndify thinks you said "
